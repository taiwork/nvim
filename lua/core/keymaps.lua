...
keymap.set("n", "<leader>f0", ":setl foldmethod=indent<CR>:setl foldenable<CR>:setl foldlevel=99<CR>") -- fold method indent
keymap.set("n", "<leader>f1", ":setl foldmethod=indent<CR>:setl foldenable<CR>:setl foldlevel=1<CR>") -- fold level 1
keymap.set("n", "<leader>f2", ":setl foldmethod=indent<CR>:setl foldenable<CR>:setl foldlevel=2<CR>") -- fold level 2
keymap.set("n", "<leader>f3", ":setl foldmethod=indent<CR>:setl foldenable<CR>:setl foldlevel=3<CR>") -- fold level 3

keymap.set("i", "<C-v>", "<C-r>+") -- paste clipboard in command mode
